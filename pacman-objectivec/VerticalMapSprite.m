...
VertexData VerticalMapVertices[] = {
...
@implementation VerticalMapSprite {
...
- (void)render {
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(VerticalMapVertices), VerticalMapVertices, GL_STATIC_DRAW);
